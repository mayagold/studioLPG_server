...
class DrawingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drawing" do
    assert_difference('Drawing.count') do
      post drawings_url, params: { drawing: { filename: @drawing.filename, medium: @drawing.medium, title: @drawing.title } }, as: :json
    end
  ...
  test "should update drawing" do
    patch drawing_url(@drawing), params: { drawing: { filename: @drawing.filename, medium: @drawing.medium, title: @drawing.title } }, as: :json
    assert_response 200
  end
