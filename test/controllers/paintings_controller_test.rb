...
class PaintingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create painting" do
    assert_difference('Painting.count') do
      post paintings_url, params: { painting: { filename: @painting.filename, medium: @painting.medium, title: @painting.title } }, as: :json
    end
  ...
  test "should update painting" do
    patch painting_url(@painting), params: { painting: { filename: @painting.filename, medium: @painting.medium, title: @painting.title } }, as: :json
    assert_response 200
  end
